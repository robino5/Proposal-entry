  ...
  return (
    <div>
      ...
      <Container>
            ...
            <Grid item xs={8}>
              ...
              <Grid item xs={12}>
                <FormControl fullWidth>
                  <InputLabel id="Varification_label" size="small">
                    S/C Code
                  </InputLabel>
                  <Select
        ...
        <div hidden={currentSetp !== 5 ? true : false}>
          <Practice />
        </div>
      </Container>
      ...
      <button
        ...
        onClick={() => updateStep(currentSetp - 1)}
        disabled={currentSetp === 1 ? true : false}
      >
        Previous
      </button>
      <button
        className="primary_button"
        onClick={() => updateStep(currentSetp + 1)}
        disabled={currentSetp === 5 ? true : false}
      >
        Next
      </button>
    </div>
